...
namespace InventorySystem_GarrettSmith
{
    internal class CustomExceptions
    {
        ...
        public bool ModifyProductExceptions(ModifyProduct modifyProduct, Product currentProduct)
        {
            ...
            //NameCheck(modifyProduct.modifyProductName.Text);
            //CheckInventory(modifyProduct.modifyProductInventory.Text, currentProduct.InStock.ToString());
            //CheckPrice(modifyProduct.modifyProductPrice.Text, currentProduct.Price.ToString());
            //CheckMax(modifyProduct.modifyProductMax.Text, currentProduct.Max.ToString());
            //CheckMin(modifyProduct.modifyProductMin.Text, currentProduct.Min.ToString());
            //MaxOverMin(modifyProduct.modifyProductMax.Text, modifyProduct.modifyProductMin.Text, currentProduct.Max.ToString(), currentProduct.Min.ToString());
        }
        ...
        //private static bool CheckInventory (string inventory, string currentInventory)
        //{
        //    if (inventory == "" || !int.TryParse(inventory, out _))
        //    {
        ...
        //private static bool CheckPrice (string price, string currentPrice)
        //{
        //    if (price == "" || !decimal.TryParse(price, out _))
        //    {
        ...
        //private static bool CheckMax(string max, string currentMax)
        //{
        //    if (max == "" || !int.TryParse(max, out _))
        //    {
        ...
        //private static bool CheckMin(string min, string currentMin)
        //{
        //    if (min == "" || !int.TryParse(min, out _))
        //    {
        ...
        //private static bool MaxOverMin(string max, string min, string currentMax, string currentMin)
        //{
        //    if (int.Parse(max) > int.Parse(min))
        //    {
        //        MessageBox.Show("Error: Max must be greater than Min.");
        //        modifyProduct.modifyProductMax.Text = currentMax;
        //        modifyProduct.modifyProductMin.Text = currentProduct.Min.ToString();
        //        return false;
        //    }
        //}
